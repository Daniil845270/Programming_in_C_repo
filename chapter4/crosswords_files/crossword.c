#include "crossword.h"
#define ACROSS ((letter == 0 || c->arr[line][(letter - 1)] == 'X' || c->arr[line][(letter - 1)] == '*') && (c->arr[line][(letter + 1)] == ' ' || c->arr[line][(letter + 1)] == '.') && (c->arr[line][letter] == ' ' || c->arr[line][letter] == '.'))
#define DOWN (((line == 0 || c->arr[(line - 1)][letter] == 'X' || c->arr[(line - 1)][letter] == '*') && (c->arr[(line + 1)][letter] == ' ' || c->arr[(line + 1)][letter] == '.') && (c->arr[line][letter] == ' ' || c->arr[line][letter] == '.')) && (line < (c->sz - 1)))
...
void meet_conditions_for_aX_and_down(const crossword* c, char across[], char down[], char* str) //finish last row
{
